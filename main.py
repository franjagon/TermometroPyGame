...
class Termometro():
    ...
    def __init__(self):
        self.disfraz = pygame.image.load("images/termometro.png")
...
class Selector():
    ...
    __unidades = ("C", "F")
    __disfraces = (pygame.image.load("images/posiC.png"), pygame.image.load("images/posiF.png"))
    __unidad = None
        ...
        while True:            
            ...
            for evento in pygame.event.get():
                if evento.type == pygame.QUIT:
                    ...
                    self.boxEntrada.valor(self.termometro.convertir(self.boxEntrada.valor(), self.selectorUnidad.unidad()))
